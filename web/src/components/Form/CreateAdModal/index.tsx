...
export const CreateAdModal = ({gameList}:CreateAdModal) => {
        ...
        >
          ...
          <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
            ...
            <footer className="mt-4 flex justify-end gap-4">
              ...
              <button
                type="submit"
                className="bg-violet-500 hover:bg-violet-600 flex items-center gap-2 px-5 h-12 rounded-md font-semibold"
              >
